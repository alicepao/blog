...
fpz_act_gender <- lm(first_z_score ~ ACTSAT_Scores + as.facotr(isMale) + ACTSAT_Scores:as.factor(isMale), data = praxis_first_zscore)
...
fpz_high_gender <- lm(first_z_score ~ HighSchoolGPA + as.facotr(isMale) + HighSchoolGPA:as.factor(isMale), data = praxis_first_zscore)
