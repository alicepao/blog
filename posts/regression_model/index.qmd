...
praxis <- praxis %>%   mutate(Ethnicity = case_when(Ethnicity == "White" ~ "White", 
                               TRUE ~ "Not White"))
...
all_everpass <- glm(ever_pass ~ ServedMission*Ethnicity*isMale*CurrentCumGPA*ACTSAT_Scores*
...
all_praxis_first_zscore <- lm(first_z_score ~ ServedMission*Ethnicity*isMale*CurrentCumGPA*ACTSAT_Scores*
                                HighSchoolGPA*ReceivedPell*FirstSemAge*FirstSemMaritalStatus*
                                asMajor*firstSemGPAinTeaching, data = praxis_first_zscore)
...
all_praxis_first_zscore <- lm(last_z_score ~ ServedMission*Ethnicity*isMale*CurrentCumGPA*ACTSAT_Scores*
                                HighSchoolGPA*ReceivedPell*FirstSemAge*FirstSemMaritalStatus*
                                asMajor*firstSemGPAinTeaching, data = praxis_last_zscore)
...
all_last_cutoff <- lm(last_score_cutoff ~ ServedMission*Ethnicity*isMale*CurrentCumGPA*ACTSAT_Scores*
                                HighSchoolGPA*ReceivedPell*FirstSemAge*FirstSemMaritalStatus*
                                asMajor*firstSemGPAinTeaching, data = praxis_last_cutoff)
